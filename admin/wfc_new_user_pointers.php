    ...
    ?>
       ...
       <table class="form-table">
          <tr>
             ...
             <td>
                <input type="checkbox" name="wfctogglepointers" value="wfc-pointers" <?php echo get_the_author_meta( 'wfctogglepointers', $user->ID ) == 'wfc-pointers' ? ' checked="checked" ' : '' ; ?> />
...
<?php }
    ...
    function wfc_pointers_save_user_profile_fields( $user_id ) {
        if ( !current_user_can( 'edit_user', $user_id ) )
            return FALSE;
        update_usermeta( $user_id, 'wfctogglepointers', $_POST['wfctogglepointers'] );
    }
