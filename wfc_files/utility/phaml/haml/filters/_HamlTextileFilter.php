<?php
     ...
     * @subpackage    Haml.filters
     */
    abstract class _HamlTextileFilter
        extends HamlBaseFilter
    {
        ...
        public function run( $text ){
            return
                '<?php	'.(!empty($this->vendorPath) ? 'require_once "'.$this->vendorPath.'";' : '').'$textile___=new '.$this->vendorClass.'();echo  $textile___->TextileThis("'.
                preg_replace( HamlParser::MATCH_INTERPOLATION, '".\1."', $text ).'");?>';
        }
    }