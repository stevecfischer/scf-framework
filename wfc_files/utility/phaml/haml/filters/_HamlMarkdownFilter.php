<?php
     ...
     * @subpackage    Haml.filters
     */
    abstract class _HamlMarkdownFilter
        extends HamlBaseFilter
    {
        /**
        ...
        public function run( $text ){
            return '<?php	'.(!empty($this->vendorPath) ? 'require_once "'.$this->vendorPath.'";' : '').'$markdown___=new '.$this->vendorClass.
            '();echo  $markdown___->safeTransform("'.preg_replace( HamlParser::MATCH_INTERPOLATION, '".\1."', $text ).'");?>';
        }
    }
