    ...
    <?php
        ...
        if( isset($_POST['updatePluginSettings']) ){
            ...
            if( $_POST['file_types'] && !empty($_POST['post_types']) ){
                ...
                // Show message:
                echo '<div id="message" style="margin-top: 10px;" class="updated"><p><strong>'.__( 'Success:', $this->plugin_locale ).'</strong> '.
                    __( 'The plugin options have been successfully updated!', $this->plugin_locale ).'</p></div>';
            } else{
                // Show message:
                echo '<div id="message" style="margin-top: 10px;" class="error"><p>'.
                    __( 'Please make sure you filled in all the required fields before submitting. At least <em><strong>one post type</strong></em> and <em><strong>one extension</strong></em> must be selected!', $this->plugin_locale ).
                    '</p></div>';
            }
        }
        ...
        <div id="post-body">
            <div id="postbox-container">
                ...
                <div id="manage-plugin-options" class="postbox">
                    <h3 class="hndle">
                        <span><?php _e( 'Available options:', $this->plugin_locale ); ?></span>
                    </h3>
                        ...
                        <form action="" method="post">
                            ...
                            <?php if( current_user_can( 'manage_options' ) ): ?>
                                <div class="metaBoxRow">
                                    ...
                                    <small><em><?php _e( 'The default capability is <code>manage_options</code> and applies to administrators.', $this->plugin_locale ); ?></em>
                                    </small>
                                    <br/>
                                    ...
                                    <small>&nbsp;&nbsp;
                                        <a href="http://codex.wordpress.org/Roles_and_Capabilities" target="_blank"><?php _e( 'User roles &amp; capabilities', $this->plugin_locale ); ?> &raquo;</a>
                                    </small>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="metaBoxRow">
                                ...
                                <small>
                                    <em><?php _e( 'If you like some users upload the featured image as the last step when publishing a post, this option is for you.', $this->plugin_locale ); ?></em>
                                </small>
                                <br/>
                                <div class="containerDiv" style="margin: 2px 0px 0px 0px; overflow: hidden;">
                                    <div class="objectRow">
