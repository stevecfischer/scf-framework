                ...
                if( $s > 0 ){
                    ...
                    if( intval( $interval->format( '%h' ) > 0 ) ){
                        return $interval->format(
                            '%h hour'.($interval->format( '%h' ) > 1 ? 's' : 's').', %I minute'.
                            ($interval->format( '%i' ) > 1 ? 's' : 's').' and %S seconds'.($s > 1 ? 's' : '') );
                    } else{
                        if( intval( $interval->format( '%I' ) > 0 ) ){
                            return $interval->format(
                                '%i minute'.($interval->format( '%i' ) > 1 ? 's' : '').' and %S seconds'.
                                ($s > 1 ? 's' : '') );
                        } else{
