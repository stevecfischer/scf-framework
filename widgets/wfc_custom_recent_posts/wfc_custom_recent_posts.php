...
class WFC_Widget_Recent_Posts extends WP_Widget {
   ...
   function widget( $args, $instance ) {
      extract($args);
      $wfc_title = apply_filters('widget_title', empty($instance['title']) ? __('Recent Posts') : $instance['title'], $instance, $this->id_base);
      ...
      $r = new WP_Query(array('posts_per_page' => $wfc_number, 'post_status' => 'publish', 'post_type' => $wfc_recent_post_type));
      if ($r->have_posts()) :
...
?>
      ...
      <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $wfc_title; ?>" /></p>

      <p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e( 'Number of Posts to Show:' ); ?></label>
      <input class="widefat" id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $wfc_number; ?>" /></p>

      <p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id('title_only'); ?>" name="<?php echo $this->get_field_name('title_only'); ?>"<?php checked( $wfc_title_only ); ?> />
